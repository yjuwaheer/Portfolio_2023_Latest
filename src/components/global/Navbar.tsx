  ...
  return (
    <>
      ...
      <nav className="fixed z-50 flex p-2 font-medium -translate-x-1/2 border-2 border-gray-200 rounded-full bottom-5 left-1/2 bg-gray-50">
        <button className="px-4 py-2 mr-2 bg-gray-200 rounded-full cursor-pointer hover:bg-gray-200">
          Home
        </button>
        <button className="flex items-center px-4 py-2 mr-2 rounded-full cursor-pointer hover:bg-gray-200">
          <div className="w-2 h-2 mr-1 bg-green-500 rounded-full"></div>
          Projects
        </button>
        <button className="px-4 py-2 mr-2 rounded-full cursor-pointer hover:bg-gray-200">
          About
        </button>
        <a
